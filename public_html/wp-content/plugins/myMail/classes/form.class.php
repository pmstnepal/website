			...
			foreach($form['order'] as $field){
				...
				switch($field){
					...
					case 'email':
						...
						$fields['email'] .= '<input placeholder="Enter Email Address" id="mymail-email-'.$formid.'" name="userdata[email]" type="text" value="'.(isset($this->values['email']) ? $this->values['email'] : '').'"'.' class="input mymail-email form-control required" tabindex="'.($tabindex++).'">';
						$fields['email'] .= '</div>';
					...
					case 'firstname':
						...
						$fields['firstname'] .= '<input id="mymail-firstname-'.$formid.'" placeholder="Enter Name" name="userdata[firstname]" type="text" value="'.(isset($this->values['firstname']) ? $this->values['firstname'] : '').'" class="input mymail-firstname'.($required ? ' required' : '').' form-control" tabindex="'.($tabindex++).'">';
