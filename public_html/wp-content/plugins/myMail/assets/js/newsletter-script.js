jQuery(document).ready(function ($) {
	...
	var _editbar = function () {
			...
			function init() {
				...
				.delegate('#wp-mymail-editor-wrap, .imagelist, .postlist', 'mouseenter', disabledrag)
				.delegate('#wp-mymail-editor-wrap, .imagelist, .postlist', 'mouseleave', enabledrag);
					...
					if (currenttext) {
						...
						if (currenttext.link){
							...
							if(current.elements.buttons.length){
								...
								currenttext.content += '<p><a href="'+currenttext.link+'" title="'+mymailL10n.read_more+'">'+mymailL10n.read_more+'</a></p>';
