...
?>
	...
	<table class="form-table">
		<tr valign="top">
			...
			<td><p><input type="checkbox" name="mymail_options[subscription_resend]" value="1" <?php if(mymail_option('subscription_resend')) echo ' checked'; ?>> <?php echo sprintf(__('resend confirmation %1$s times with a delay of %2$s hours if user hasn\'t confirmed the subscription' ,'mymail'), '<input type="text" name="mymail_options[subscription_resend_count]" value="'.esc_attr(mymail_option('subscription_resend_count')).'" class="small-text">', '<input type="text" name="mymail_options[subscription_resend_time]" value="'.esc_attr(mymail_option('subscription_resend_time')).'" class="small-text">') ?></p></td>
		</tr>
		<tr valign="top">
	...
	<table class="form-table" id="dkim_keys_active">
		...
		<tr valign="top">
			...
			<input type="text" name="mymail_options[dkim_private_hash]" value="<?php echo esc_attr(mymail_option('dkim_private_hash')); ?>" class="regular-text dkim"></td>
		</tr>
	</table>
	<?php endif; ?>
	<table class="form-table">
