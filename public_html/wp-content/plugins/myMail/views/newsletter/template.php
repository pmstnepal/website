...
<div style="display:none" id="mymail_editor_holder"><?php
function mymail_mce_before_init($mceInit, $editor_id){
	...
	$mceInit['theme_advanced_buttons1'] = 'bold,italic,underline,blockquote,strikethrough,bullist,numlist,justifyleft,justifycenter,justifyright,undo,redo,link,unlink,removeformat,fullscreen';
	return $mceInit;
}
